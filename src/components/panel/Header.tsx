import { ChevronDown, Settings, LogOut, Menu, X, Moon, Sun } from 'lucide-react'
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            <div className="flex items-center gap-3 sm:gap-5">
              ...
              <div className={`
                ...
                ${isScrolled ? 'w-8 h-4 sm:w-10 sm:h-5' : 'w-10 h-5 sm:w-12 sm:h-6'}
              `}>
                <ICPLogo className="w-full h-full" />
              </div>
            ...
            <div className="relative hidden lg:block" onClick={(e) => e.stopPropagation()}>
              ...
              >
                <div className="text-xs sm:text-sm">
                  <div className="font-medium text-left">{user?.email?.split('@')[0] || 'User'}</div>
                  <div className="text-muted-foreground text-xs leading-tight">{user?.email || 'user@example.com'}</div>
                </div>
